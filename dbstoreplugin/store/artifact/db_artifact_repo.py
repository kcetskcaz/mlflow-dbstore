...
from dbstoreplugin.store.db.initial_artifact_store_models import Base as InitialBase
from dbstoreplugin.store.db.initial_artifact_store_models import SqlArtifact
